...
void setup() 
{
  ...
  set_last_value(millis(),0,0,0,0,0,0);
      ...
      rollPID.SetOutputLimits(-60,60); //limits the PID loop to output numbers in between -90 and 90. I used values from -90 to 90 in order to better visualize the glider position(when flaps are flat, the PID output is 0)
